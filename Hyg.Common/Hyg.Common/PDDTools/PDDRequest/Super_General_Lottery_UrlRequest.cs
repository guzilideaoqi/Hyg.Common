...
文件类名 : Super_General_Lottery_UrlRequest.cs
创建人员 : Mr.Hu
创建时间 : 2020-10-27 14:09:07 
备注说明 : 多多客工具生成转盘抽免单url--请求参数
...
{
    /// <summary>
    /// 多多客工具生成转盘抽免单url--请求参数
    /// </summary>
    public class Super_General_Lottery_UrlRequest : Custom_ParamterEntity
    {
        /// <summary>
        /// 是否生成qq小程序
        /// </summary>
